...
import { PrPrediction } from './apiClient';
import { GitInfo } from './gitHelper';

export class PrPredictorSidebarProvider implements vscode.WebviewViewProvider {
    ...
    setPrediction(prediction: PrPrediction, gitInfo: GitInfo) {
        if (this._view) {
